...
In other words, in this specific cohort with no censored observations until the end of the study and identical times of entry among all partiicpants, that last person who needed to die to bring the total percentage of the cohort dead to or above 25\% did so \Sexpr{death_all_25_percentile} years after the start of the study.
...
time_table <- 
  ...
  mutate(Covariate = c("Current Smoker", 
                       ...
                       "Current Smoker by Time", 
                       "Age by Time Interaction", 
                       "Female by Time Interaction", 
                       "Education: High School by Time", 
                       "Education: Some College by Time", 
                       "Education: College Degree by Time")) %>% 
...
print(xtable(time_table, caption = "Estimates of associations between baseline smoking status and mortality including adjustment for potential interactions with time. Framingham Cohort Study. 1948-1972, Framingham, MA."), table.placement = "H", caption.placement = "top", caption.width = "11cm", include.rownames = FALSE)
